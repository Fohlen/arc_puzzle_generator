...
from arc_puzzle_generator.collisions import CollisionRule, CollisionResult, orthogonal_direction
...
class BoundingBoxRule(CollisionRule):
    ...
    def __call__(self, output_grid: np.ndarray, neighbourhood: np.ndarray, direction: Direction) -> Optional[
        CollisionResult]:
